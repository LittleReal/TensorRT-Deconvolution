...
def build_engine():
    ...
    conv0=network.add_convolution_nd(input=data, num_output_maps=128, kernel_shape=(256,3,3), kernel=conv0_w,bias=conv0_b)
...
if __name__ == "__main__":
    ...
    with open("model/trt/conv_3d_1.trt", "wb") as f:
        f.write(plan)
    f.close()
