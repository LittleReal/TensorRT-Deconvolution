...
def build_engine():
    ...
    print(conv_0_bias.shape)
    print(conv_0_weight.shape)
    conv0_b=conv_0_bias.asnumpy()

    conv0=network.add_convolution_nd(input=data, num_output_maps=128, kernel_shape=(256,3,3), kernel=conv0_w_t,bias=conv0_b)
...
if __name__ == "__main__":
    ...
    with open("model/trt/conv_3d_2.trt", "wb") as f:
        f.write(plan)
    f.close()
