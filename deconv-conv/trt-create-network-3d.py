...
def build_engine():
    ...
    conv0=network.add_convolution_nd(input=deconv0.get_output(0), num_output_maps=16, kernel_shape=(1, 3,3), kernel=conv0_w_t, bias=conv0_b)
...
if __name__ == "__main__":
    ...
    with open("model/trt/deconv-conv_3d.trt", "wb") as f:
        f.write(plan)
    f.close()
