...
params_path="model/mxnet/deconv-conv-0000.params"
...
def build_engine():
    ...
    conv0=network.add_convolution_nd(input=deconv0.get_output(0), num_output_maps=16, kernel_shape=(3,3), kernel=conv0_w,bias=conv0_b)
    conv0.stride=(1,1)
    conv0.padding=(1,1)
...
if __name__ == "__main__":
    ...
    with open("model/trt/deconv-conv.trt", "wb") as f:
        f.write(plan)
    f.close()
